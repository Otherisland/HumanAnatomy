package com.bn.hk.humananatomy.util;//声明包
...
public class LoadUtil 
{
    ...
    (String fname, Resources r, ShowView sv, String sname, ShowActivity sa)
    {
    	//加载后物体的引用
    	...
    	try
    	{
		    ...
		    //创建加载物体对象
		    lo=new LoadedObjectVertexNormalTexture(sv,vXYZ,nXYZ,tST,sname);
    	}
    	catch(Exception e)
    	{
